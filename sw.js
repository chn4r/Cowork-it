const CACHE='cowork-it-v31-shell-1';
const SHELL=['./','./index.html','./styles.css','./app.js','./network.js','./leaflet-loader.js','./manifest.webmanifest','./offline.html','./icons/icon-192.png','./icons/icon-512.png'];
